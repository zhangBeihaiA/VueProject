  ...
  <div class="trade-container">
    ...
    <div class="content">
      ...
      <div class="address clearFix"  v-for="a in addressInfo" :key="a.id" >
        <span class="username" :class="{selected:a.isDefault==1}">{{a.consignee}}</span>
      ...
      <div class="detail">
        ...
        <ul class="list clearFix" v-for="d in detailArrayList" :key="d.skuId">
          <li>
            <img :src="d.imgUrl" alt="" style="width:82px,height:182px">
          </li>
          <li>
            <p>
              {{d.skuName}}
    ...
    <div class="trade">
      <div class="price">应付金额:　<span>{{ orderInfo.totalNum }}</span></div>
